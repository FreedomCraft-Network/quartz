...
See the [documentation](https://quartz.freedomcraft.wiki) for how to get started.
`,
    )
  }
  ...
  // setup remote
  execSync(
    `git remote show upstream || git remote add upstream https://github.com/FreedomCraft-Network/quartz.git`,
    { stdio: "ignore" },
  )
  ...
  • Hosting your Quartz online (see: https://quartz.freedomcraft.wiki/hosting)
`)
}
