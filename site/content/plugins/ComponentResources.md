...
- Source: [`quartz/plugins/emitters/componentResources.ts`](https://github.com/FreedomCraft-Network/quartz/blob/v4/quartz/plugins/emitters/componentResources.ts).
